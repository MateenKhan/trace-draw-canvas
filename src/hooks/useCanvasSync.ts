            ...
            if (obj.type === 'i-text' || obj.type === 'text') {
                ...
                setTextStyle(prev => {
                    ...
                    return {
                        ...
                        glowColor: (textObj.shadow?.offsetX === 0 && textObj.shadow?.offsetY === 0 && (textObj.strokeWidth || 0) === 0) ? (textObj.shadow?.color || 'transparent') : prev.glowColor,
                        glowBlur: (textObj.shadow?.offsetX === 0 && textObj.shadow?.offsetY === 0 && (textObj.strokeWidth || 0) === 0) ? (textObj.shadow?.blur || 0) : prev.glowBlur,
                        offsetColor: (textObj.shadow?.offsetX !== 0 || textObj.shadow?.offsetY !== 0) ? (textObj.shadow?.color || '#000000') : prev.offsetColor,
                        offsetX: textObj.shadow?.offsetX || 0,
                        offsetY: textObj.shadow?.offsetY || 0,
                        offsetBlur: (textObj.shadow?.offsetX !== 0 || textObj.shadow?.offsetY !== 0) ? (textObj.shadow?.blur || 0) : prev.offsetBlur,
                        outlineColor: textObj.stroke || prev.outlineColor,
                        outlineWidth: textObj.strokeWidth || 0,
                        outlineBlur: (textObj.shadow?.offsetX === 0 && textObj.shadow?.offsetY === 0 && (textObj.strokeWidth || 0) > 0) ? (textObj.shadow?.blur || 0) : prev.outlineBlur,
                        outlineOffsetX: textObj.outlineOffsetX || 0,
                        outlineOffsetY: textObj.outlineOffsetY || 0,
                        outlineGap: textObj.outlineGap || 0,
                        outlineGapColor: textObj.outlineGapColor || 'transparent',
                        paintFirst: textObj.paintFirst || 'stroke',
