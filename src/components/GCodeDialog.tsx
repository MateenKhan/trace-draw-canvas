...
import { ToolPath, pathToPoints } from "@/lib/gcode";
...
export const GCodeDialog = ({ open, onOpenChange, canvas }: GCodeDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto">
        ...
        <div className="mt-2">
          <GCodePanel toolPaths={toolPaths} onExportGCode={handleExportGCode} />
          {toolPaths.length === 0 && (
