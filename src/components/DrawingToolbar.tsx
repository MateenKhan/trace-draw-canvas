  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex flex-col pointer-events-none">
      ...
      <div className="w-full flex justify-center pointer-events-auto">
        <div className="w-full max-w-3xl px-4 animate-slide-up">
          ...
          {['select', 'draw', 'shapes', 'image'].includes(activeCategory || '') && (
            <div className="mb-2 bg-background/80 backdrop-blur-md border border-border/50 shadow-xl rounded-2xl p-2 flex gap-2 overflow-x-auto scrollbar-thin mx-auto max-w-full justify-start md:justify-center">
      ...
      <div className="w-full bg-background/95 backdrop-blur-md border-t border-panel-border pb-safe pointer-events-auto">
        <div className="flex items-center gap-1 px-4 py-2 overflow-x-auto scrollbar-thin no-scrollbar justify-start md:justify-center min-w-full">
